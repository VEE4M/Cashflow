...
class IncomeListAdapter(): RecyclerView.Adapter<IncomeListAdapter.ViewHolder>() {
    ...
    var incomeList = emptyList<IncomeItem>()
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.itemView.text_income_title.setText(incomeList[position].title)
        holder.itemView.text_income_amount.setText(incomeList[position].netAmount.toString() + "€")
        holder.itemView.text_income_type.setText(incomeList[position].getIncomeTypeAsString())
